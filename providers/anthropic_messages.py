...
class AnthropicMessagesTransport(BaseProvider):
    ...
    def _rotate_key_on_429(self, exc: Exception = None) -> bool:
        """Called by the global rate limiter when a 429 is hit."""
        return self._config.mark_key_exhausted()
        ...
        *,
        ...
        async with self._global_rate_limiter.concurrency_slot():
            ...
            while True:
                ...
                try:
                    response = await self._global_rate_limiter.execute_with_retry(
                        self._validated_stream_send, body, req_tag=req_tag, on_429=self._rotate_key_on_429
                    )
                    stream_opened = True
