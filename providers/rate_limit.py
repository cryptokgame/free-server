...
class GlobalRateLimiter:
    ...
    async def execute_with_retry(
        ...
        *args: Any,
        ...
        jitter: float = 1.0,
        on_429: Callable[[Exception], bool] | None = None,
        **kwargs: Any,
    ) -> Any:
        ...
        for attempt in range(total_attempts):
            ...
            try:
                ...
                if status == 429 and on_429 is not None:
                    if on_429(e):
                        logger.info("Fill First strategy: Rotated to a new fresh API key. Bypassing wait!")
                        total_attempts += 1
                        continue
